 ...
 */
final class Version20210208152017 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE places (id INT AUTO_INCREMENT NOT NULL, rooms_id INT NOT NULL, is_reserved TINYINT(1) NOT NULL, INDEX IDX_FEAF6C558E2368AB (rooms_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
